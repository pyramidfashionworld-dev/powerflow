...
import DisconnectionManagement from './ConsumerDataComponent';
...
export default function DashboardHome({ onSelectModule }) {
  ...
  // Show Disconnection Management Component
  if (activeModule === 'disconnection') {
    return (
      <div>
        <button
          onClick={() => {
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{
                ...
                {module.requiresFile ? 'Upload & Access' : 'Access Module'}
